// Note: 
// This file is copied from older Caffe version, deleted in `Switched multi-GPU to NCCL` (Jan 6, 2017)
// It is updated to its latest version before being deleted (both cpp and hpp)
